...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        ...
        ContactGroupDao.createTable(db, ifNotExists);
        MessageDao.createTable(db, ifNotExists);
        ContactToGroupDao.createTable(db, ifNotExists);
        ContactToMessageDao.createTable(db, ifNotExists);
        GroupToMessageDao.createTable(db, ifNotExists);
    }
    
    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        ContactsDao.dropTable(db, ifExists);
        ContactGroupDao.dropTable(db, ifExists);
        MessageDao.dropTable(db, ifExists);
        ContactToGroupDao.dropTable(db, ifExists);
        ContactToMessageDao.dropTable(db, ifExists);
        GroupToMessageDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(ContactGroupDao.class);
        registerDaoClass(MessageDao.class);
        registerDaoClass(ContactToGroupDao.class);
        registerDaoClass(ContactToMessageDao.class);
        registerDaoClass(GroupToMessageDao.class);
    }
