...
/**
 * viewPager 父类
 * Created by huangjinxin on 15/4/27.
 */
public class BaseTabStrip extends FrameLayout {
    ...
    protected int scrollOffset = 52;

    protected int lastScrollX = 0;

    protected int indicatorColor = 0xFFFF5252;
    protected int underlineColor = 0xFFd0cecc;
    protected int dividerColor = 0x1A000000;

    protected int indicatorHeight = 4;
    protected int underlineHeight = 1;
    protected int dividerPadding = 12;
    protected int tabPadding = 24;
    protected int dividerWidth = 1;

    protected int tabTextSize = 16;
    protected int tabTextColor = 0xFF666666;
    protected int tabTextSelectedColor = 0xFF660066;
    protected Typeface tabTypeface = null;
    protected int tabTypefaceStyle = Typeface.NORMAL;

    protected int tabBackgroundResId = R.drawable.background_tab_strip;
    ...
    public BaseTabStrip(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs);
    ...
    private void initStyle(Context context, AttributeSet attrs) {
        ...
        tabTextSelectedColor = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, tabTextSelectedColor, dm);
